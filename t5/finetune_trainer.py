...
class DataTrainingArguments:
    ...
    val_name: Optional[str] = field(default="val", metadata={"help": "# data name for validating."})
    test_name: Optional[str] = field(default="test", metadata={"help": "# data name for testing."})
...
def main():
    ...
    # st_vocab, ed_vocab = ["<%s>"%i for i in range(20)], ["<／%s>"%i for i in range(20)]
    # tokenizer.add_special_tokens({"additional_special_tokens": st_vocab + ed_vocab + ["<newline>", "<eot>", "<eoc>"]})
    # token_sen = tokenizer.encode('''这一刻，我长大了<eod><extra_id_0>成长是一本书，需要我们细细品读；成长是一场比赛，需要我们拼尽全力；成长也是一次冒险，需要我们克服困难。那一刻，我长大了。<extra_id_1><newline>有一次，我自己出门散步，走着走着被一块砖头绊倒了，我跌在地上觉得自己快散架了，一时间不知怎么办才好。<newline>周围的花草被微风吹着，我的眼泪>也溢出了眼眶，打湿了我的脸庞和衣领。我哭着哭着觉得应该想办法解决，于是我用手撑着地面，咬着牙，用尽全力使自己站起来——我站起来了。<newline>一瞬间我觉得身上的疼痛全没了，温暖的阳光环绕着我，温柔的风吹过我的脸庞，吹干了我的泪水，也吹干了我的绝望。<newline>这一刻，我懂得了要勇敢镇定地解决困难。这一刻，我长大了0<eop>宝贝，你开头的部分恰当运用修辞方法，让文章开头的语言更加优美，给你点赞哟''')
    # print(token_sen)
